...
export const ExternalLinkIcon = ({ className = "h-5 w-5" }: { className?: string }) => (
...
export const StarIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="0.5" className="h-4 w-4 text-primary">
...
export const BeerIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5">
        <path d="M14 3.5c0 2 2.5 3.5 2.5 5.5V20H6v-9c0-2 2.5-3.5 2.5-5.5C8.5 2 9 1 10 1s1.5 1 1.5 2.5c0 .75.12 1.42.33 2" />
        <path d="M14 9.5c-1 0-2.5-1-2.5-2.5" />
        <path d="M18.5 9.5a2.45 2.45 0 0 1-2.5-2.5" />
        <path d="M21 11h-1" />
        <path d="M18 8h1" />
    </svg>
);
...
export const BookmarkIcon = ({ className = "h-5 w-5" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const RefreshCwIcon: React.FC<RefreshIconProps> = ({ className }) => (
...
export const StoutlyLogo: React.FC<LogoProps> = ({ className }) => (
    <svg 
        viewBox='0 0 1024 1024' 
        xmlns='http://www.w3.org/2000/svg' 
        className={className}
        aria-label="Stoutly Logo"
    >
        <rect width="1024" height="1024" rx="220" fill="#2C1F17"/>
        <g transform="translate(102.4, 118.784) scale(8.192)">
            <path 
